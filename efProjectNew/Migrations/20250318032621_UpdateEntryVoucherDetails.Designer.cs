...
namespace efProjectNew.Migrations
{
    ...
    [Migration("20250318032621_UpdateEntryVoucherDetails")]
    partial class UpdateEntryVoucherDetails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("efProjectNew.Entities.EntryVoucherDetail", b =>
                {
                    b.Property<int>("ReferenceNumber")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ReferenceNumber", "ProductId");

                    b.HasIndex("ProductId");

                    b.ToTable("EntryVoucherDetails");
                });
            ...
            modelBuilder.Entity("efProjectNew.Entities.EntryVoucherDetail", b =>
                {
                    b.HasOne("efProjectNew.Entities.Product", "Product")
                        .WithMany("EntryVoucherDetails")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("efProjectNew.Entities.EntryVoucher", "EntryVoucher")
                        .WithMany("EntryVoucherDetails")
                        .HasForeignKey("ReferenceNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("EntryVoucher");
            ...
            modelBuilder.Entity("efProjectNew.Entities.EntryVoucher", b =>
                {
                    b.Navigation("EntryVoucherDetails");
                });
